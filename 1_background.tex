...
\subsection{Text representation and code editors}
...
%\footnote{A formal study of visual programming languages, proper classification in terms of statistics and methodical examination are not the focus of this thesis. \js{No ja bym jednak tego nie pisał i zamiast tego zrobił solidny przegląd literatury.}}.
