...
The primary representation of a program in Dual is the syntax tree. Although it is not directly editable, it can contain references to any number of editable representations.
